...
namespace carrot::utils::json {
    ...
    {
    public:
        [[nodiscard]] bool is_object() const { return _value && _value->type == json_type::object; }
        [[nodiscard]] bool is_array() const { return _value && _value->type == json_type::array; }
        [[nodiscard]] bool is_string() const { return _value && _value->type == json_type::string; }
        [[nodiscard]] bool is_number() const { return _value && _value->type == json_type::number; }
        [[nodiscard]] bool is_bool() const { return _value && _value->type == json_type::boolean; }
        [[nodiscard]] bool is_null() const { return !_value || _value->type == json_type::null_value; }
