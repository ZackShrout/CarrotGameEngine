    ...
    namespace {
        ...
        [[nodiscard]] bool acquire_shared_wayland_state()
        {
            if (g_shared_wayland.ref_count++ > 0)
                return g_shared_wayland.display != nullptr &&
            ...
            return g_shared_wayland.compositor != nullptr && g_shared_wayland.xdg_wm_base != nullptr;
        }
        ...
        void release_shared_wayland_state() noexcept
        {
            ...
            g_shared_wayland.seat_name = 0;
            g_shared_wayland.seat_version = 0;
            g_shared_wayland.poll_generation = 0;
            g_shared_wayland.last_pumped_generation = 0;
        }
