...
namespace carrot::world {
    ...
    public:
        ...
        void set_camera_follow_enabled(bool enabled) noexcept { _camera_follow_enabled = enabled; }
        [[nodiscard]] bool camera_follow_enabled() const noexcept { return _camera_follow_enabled; }
    ...
    private:
        ...
        bool _camera_follow_enabled{ true };
